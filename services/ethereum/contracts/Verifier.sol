...
contract Verifier {
    ...
    uint sealed = 0; // IC parameter add counter.
    uint i = 0;
    ...
    // Can probably remove the msg.gas checks, the sealed precondition is just
    // to make sure that the addIC successfully adds everything and doesnt fail
